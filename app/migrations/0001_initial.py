    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_type', models.CharField(blank=True, max_length=500, null=True)),
                ...
                ('arabic_reason', models.CharField(blank=True, max_length=500, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomerModel',
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to='Customer_Profile_Images/')),
                ...
                ('delete_reason_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.reasons')),
            ...
            managers=[
                ('manager', app.models.AppUserManager()),
